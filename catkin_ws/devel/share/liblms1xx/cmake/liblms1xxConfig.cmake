...
if("TRUE" STREQUAL "TRUE")
  set(liblms1xx_SOURCE_PREFIX /home/pg/catkin_ws/src/liblms1xx)
  set(liblms1xx_DEVEL_PREFIX /home/pg/catkin_ws/devel)
  ...
  set(liblms1xx_INSTALL_PREFIX /home/pg/catkin_ws/install)
...
if(NOT "/home/pg/catkin_ws/src/liblms1xx/libLMS1xx" STREQUAL "")
  set(liblms1xx_INCLUDE_DIRS "")
  set(_include_dirs "/home/pg/catkin_ws/src/liblms1xx/libLMS1xx")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'liblms1xx' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pg/catkin_ws/src/liblms1xx/${idir}'.  Ask the maintainer 'kp <kp@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${liblms1xx_dep}_FOUND)
      find_package(${liblms1xx_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${liblms1xx_dep} REQUIRED ${depend_list})
  endif()
