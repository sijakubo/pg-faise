...
void HubFlow::driveCallbackMPS(const epos2_control::HubFlow speed)
{
	hubflowSettings.targetVelocityMPS[0] = speed.hub;
	hubflowSettings.targetVelocityMPS[1] = speed.flow;
}
...
{
	double targetVelocityRPM[5];
	targetVelocityRPM[0] = 1000;
	targetVelocityRPM[1] = 1000;
	targetVelocityRPM[2] = 1000;
	targetVelocityRPM[3] = 1000;
	targetVelocityRPM[4] = 1000;
