...
\DeclareGraphicsExtensions{.pdf,.png,.jpg,.jpeg,.mps}   % More extensions can be added
...
\begin{titlepage}
  ...
  \begin{figure}[h!]
    \centering
    \includegraphics[natwidth=200bp,natheight=287bp, width=70bp]{CvO-Oldenburg-Logo}    % Ggf. Copyright beachten - ansonsten nur für Gebrauch an der CvO
  \end{figure}
  ...
  \begin{figure}[h!]
    \centering
    \includegraphics[natwidth=200bp,natheight=287bp, width=70bp]{faise_logo_gross}    % Ggf. Copyright beachten - ansonsten nur für Gebrauch an der CvO/VLBA
  \end{figure}
...
\newpage
\include{./kapitel/abschliessendeErklaerung}
